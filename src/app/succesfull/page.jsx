...
const page = () => {
  return (
    <div className="mx-auto mt-20 max-w-screen-xl">
      <title>Domain Choosen Succesfully CPBYTE | Technical Club Of KIET</title>
      <h2 className=" mx-auto max-w-screen-xl items-center text-center mb-6 font-sans text-3xl  font-bold leading-none tracking-tight text-gray-900 sm:text-4xl ">
        <span className="relative inline-block">
          <span className="relative">
            Choice <span className=""></span>SUBMITTED
          </span>
        </span>{" "}
        <br />
        <br />
      ...
      <div className="ml-[15vw] mr-[15vw] md:ml-[30%] md:mr-[30%] justify-center"></div>
    </div>
  );
};
