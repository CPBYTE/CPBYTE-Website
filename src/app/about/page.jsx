...
const page = () => {
  const Activities = [
    ...
    },
    {
      id: 3,
      details:
        "Collaboration with other colleges which are a part of CPBYTE community.",
    },
    {
      id: 4,
      details:
          ...
          <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
            <div className="max-w-xl mb-6">
              ...
              <p className="text-base text-gray-700 md:text-lg">
                ...
                domain through real-world exposure and hands-on learning. <br />
        ...
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span className="relative inline-block">
              <span className="relative">Activities by CPBYTE</span>
            </span>{" "}
          </h2>
        </div>
        ...
        <div className="flex flex-col max-w-screen-xl overflow-hidden bg-white  rounded  lg:flex-row sm:mx-auto">
          ...
          <div className="flex flex-col justify-center py-8 bg-white lg:p-20  lg:w-1/2">
            <p className="mb-5 text-gray-800 text-xl ml-2 tracking-wide">
              ...
              <span className="font-bold">technical</span> as well as
              <span className="font-bold"> competitive</span> practices in the
