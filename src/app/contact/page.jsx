              ...
              <form className="mt-12">
                <div className="-mx-2 md:items-center md:flex">
                  ...
                  <div className="flex-1 px-2 mt-4 md:mt-0">
                    ...
                    <input
                      type="email"
                      placeholder="cpbytekiet@gmail.com"
                      className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                    />
                  </div>
                </div>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
              ...
              <div className="mt-6 w-80 md:mt-8">
                ...
                <div className="flex mt-4 -mx-1.5 ">
                  ...
                  <a
                    className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                    href="https://www.linkedin.com/in/cpbyte-kiet-44338a254?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                  >
                    <svg
                      className="w-8 h-8"
                      viewBox="0 0 24 24"
                  ...
                  <a
                    className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500"
                    href="https://www.instagram.com/cpbyte_kiet?igsh=N2t6MXcxY2U3bmFp"
                  >
                    <svg
                      className="w-8 h-8"
                      viewBox="0 0 24 24"
